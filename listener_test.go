...
func TestRetrieveMessage(t *testing.T) {
	listener, _ := new(Listener).InitWithConf("your-stream", "0", ShardIterTypes[3], "accesskey", "secretkey", "us-east-1")
	producer, _ := new(Producer).InitWithConf("your-stream", "0", ShardIterTypes[3], "accesskey", "secretkey", "us-east-1")
